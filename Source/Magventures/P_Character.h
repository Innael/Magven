...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Attack")
	float CurrentMaxDamage = 2;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Attack")
	float CurrentMinSWDamage = 0;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Attack")
	float CurrentMaxSWDamage = 0;
...
public:	
	...
	void RecalculateWeight(float PersonalInventoryWeight, float ShrdWeight);

	UFUNCTION(BlueprintCallable, Category = "Weight")
	float GetMaxCarryingCapacity();
